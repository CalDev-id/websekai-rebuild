...
import ImgDeku from "@/public/Images/deku.png"
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div className="pl-5">
                        <h1 className="py-10 lg:py-16 font-semibold text-2xl text-white">
                            {props.name}
                        </h1>
                        ...
                        <div>
                            ...
                            <Image src={ImgDeku} alt="Icon" className="absolute pl-5 z-0 opacity-30 w-full -bottom-0 -right-0 lg:w-full"/>
                        </div>
                    </div>
                </section>
            </section>
